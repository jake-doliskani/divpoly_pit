...
in $O(\log^3p \loglog^3p)$ bit operations. In fact, the algorithm exploits an interesting 
...
\label{equ:divpoly1}
	...
	\end{array}
\end{equation}
We also define the following polynomials that we will use in the subsequent sections.
\begin{equation}
...
abscissas of the points $kP$. But the univariate polynomial $\tilde{\psi}_p$ has degree at most $(p 
- 1) / 2$ so it is uniquely determined by $(p + 1) / 2$ pairs $(a, \tilde{\psi}_p(a))$. It follows 
that $\tilde{\psi}_p^p = 1$, and hence $\psi_p = 1$. It only remains to efficiently find a point of 
high order on $E$. For this, we adapt the approach of Voloch \cite{voloch2007,voloch2010}.
...
\begin{proof}
	...
	projection to the first coordinate, that is $f(P) = x_P$ for any point $P$ on $E$. A point $(P, 
...
From the proof of Theorem \ref{theo:order-general} we see that the point $P$ has order at 
...
\begin{table}
	...
	\begin{tabular}{ccccc}
		...
		\midrule[0.7pt]
		33 & 0.004 & 0.003 & 0.316 & 0.180 \\
		65 & 0.007 & 0.006 & 0.673 & 0.595 \\
		129 & 0.007 & 0.006 & 1.771 & 2.783 \\
		257 & 0.019 & 0.012 & 4.734 & 12.59 \\
		385 & 0.030 & 0.024 & 8.832 & 32.47 \\
		513 & 0.049 & 0.039 & 14.21 & 67.66 \\
		641 & 0.074 & 0.055 & 21.69 & 140.2 \\
		769 & 0.135 & 0.084 & 37.08 & 256.4 \\
		897 & 0.162 & 0.110 & 49.46 & 384.8 \\
		1025 & 0.219 & 0.134 & 63.20 & 556.9 \\		
		\midrule[0.7pt]
	\end{tabular}
