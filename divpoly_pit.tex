...
\ref{lem:ss_divpoly}, but we are not concerned with that. In fact, this is easily done in practice 
...
Lemmas \ref{lem:ord_divpoly}, \ref{lem:ss_divpoly} and Theorem \ref{theo:Schwartz-Zippel} give a 
...
non-constant function on $E$ then either $P$ or $f(P)$ has order at least $q^{nc}$. So 
