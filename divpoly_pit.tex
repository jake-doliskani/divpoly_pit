...
\begin{proposition}
	Let $P \in E$ be a point of order $r$, with $(r, p) = 1$, that satisfies (\ref{equ:ss-strong}). 
...
(\ref{equ:ss-strong}) then $\ang{P}$ is invariant under the action of $\pi$. Then, by the above, 
